...
namespace ChessLibrary
{
	...
	public class Cell
	{
		...
		public Cell(string strLoc)
		{
			...
			{
				ColValue=char.Parse(strLoc.Substring(0,1).ToUpper())-64; // Get row from first ascii char i.e. a=1, b=2 and so on
				RowValue=int.Parse(strLoc.Substring(1,1));				  // Get column value directly, as it's already numeric
			}
		}
		...
		public bool IsEmpty()
		{
			return PieceValue == null || PieceValue.Type == Piece.PieceType.Empty;
		}
		...
		public bool IsOwnedByEnemy(Cell other)
		{
			if (IsEmpty())
                ...
                return PieceValue.Side.type != other.piece.Side.type;
		}
